			...
			<ul class="nav">
				...
				<li class="parent">
					...
					<ul class="children collapse in" id="sub-item-1-employee">
						...
						<li>
							<a class="active-sub-menu" href="employee_list.php">
							  ...
							  <?php
							 	...
							 	<div class="col-xs-12">
							 		<center>
								 		...
								 		<small>Member since <?php echo $date_class->dateFormatMonthYear($row_profile_emp->DateCreated); ?></small>
						 			</center>
						 		</div>
							 	<div class="col-xs-12">
							 		<fieldset>
							 			<legend>Basic Information</legend>
							 			<div class="col-xs-12 col-md-8 content-view-emp">
							 				<b><span class="glyphicon glyphicon-home" style="color:#2E86C1;"></span> Address:</b> <?php echo $row_profile_emp->Address; ?>
						 				</div>

						 				<div class="col-xs-6 col-md-4 content-view-emp">
							 			...
							 			<div class="col-xs-6 col-md-4 content-view-emp">
								 			<b><span class="glyphicon glyphicon-phone-alt" style="color:#2E86C1;"></span> Contact No:</b> <?php echo $row_profile_emp->ContactNo; ?>
							 			</div>


							 			<div class="col-xs-12 content-view-emp">
								 			<b><span class="glyphicon glyphicon-envelope" style="color:#2E86C1;"></span> Email Address:</b> <?php echo $row_profile_emp->EmailAddress; ?>
							 			</div>
						 			</fieldset>
						 		</div>
						 		...
						 		<div class="col-xs-12">
						 			...
						 			<br/>
							 		<fieldset>
							 			<legend>Government Information</legend>
							 			<div class="col-xs-6 col-md-3 content-view-emp">
								 			<b><img src="img/government images/SSS-Logo.jpg" class="government-logo" alt="SSS-Logo"/><span>&nbsp; SSS No:</b> <?php echo $row_profile_emp->SSS_No; ?>
							 			</div>
							 			<div class="col-xs-6 col-md-3 content-view-emp">
								 			<b><img src="img/government images/pag-ibig-logo.jpg" class="government-logo" alt="Pag-big-Logo"/><span>&nbsp; Pag-ibig No:</b> <?php echo $row_profile_emp->PagibigNo; ?>
							 			</div>
							 			<div class="col-xs-6 col-md-3 content-view-emp">
								 			<b><img src="img/government images/bir-Logo.jpg" class="government-logo" alt="BIR-Logo"/><span>&nbsp; Tin No:</b> <?php echo $row_profile_emp->TinNo; ?>
							 			</div>
							 			<div class="col-xs-6 col-md-3 content-view-emp">
								 			<b><img src="img/government images/philhealth-logo.jpg" class="government-logo" alt="Philhealth-Logo"/><span>&nbsp; Philhealth No:</b> <?php echo $row_profile_emp->PhilhealthNo; ?>
							 			</div>
						 			</fieldset>
					 			</div>
