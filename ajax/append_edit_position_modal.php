...
<form class="form-horizontal" action="php script/update_position_script.php" method="post">
	<div class="container-fluid">								
		...
		<div class="input-group">
			<input type="text" name="position" value="<?php echo utf8_encode($position_class->getPositionById($position_id)->Position); ?>" autocomplete="off" placeholder="Enter Department" class="form-control" required="required">
