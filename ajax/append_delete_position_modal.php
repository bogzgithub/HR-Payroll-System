...
<form class="" action="" method="post">
	<div class="container-fluid">
		<div style="text-align:center;">					
			<span><span class="glyphicon glyphicon-warning-sign" style="color:#CB4335;"></span> Are you sure you want to delete the <b><?php echo utf8_encode($position_class->getPositionById($position_id)->Position); ?> Position?</b></span>
		</div>						
	</div>
</form>
