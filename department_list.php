...
<html>
	<head>
		...
		<script type="text/javascript" language="javascript">
			...
			<?php
				// error in updating
				if (isset($_SESSION["update_error_msg_department"])){
					echo '$(document).ready(function() {
						$("#error_modal_body").html("'.$_SESSION["update_error_msg_department"].'");
						$("#errorModal").modal("show");
					});';
					$_SESSION["update_error_msg_department"] = null;
				}

				// success in updating
				if (isset($_SESSION["update_success_msg_department"])){
					echo '$(document).ready(function() {
						$("#success_modal_body").html("'.$_SESSION["update_success_msg_department"].'");
						$("#successModal").modal("show");
					});';
					$_SESSION["update_success_msg_department"] = null;
				}


				// success in deleting
				if (isset($_SESSION["success_msg_del_dept"])){
					echo '$(document).ready(function() {
						$("#success_modal_body_del").html("'.$_SESSION["success_msg_del_dept"].'");
						$("#successDelete").modal("show");
					});';
					$_SESSION["success_msg_del_dept"] = null;
				}

				// error in adding
				if (isset($_SESSION["department_error_msg"])){
					echo '$(document).ready(function() {
						$("#add_error_modal_body").html("'.$_SESSION["department_error_msg"].'");
						$("#add_errorModal").modal("show");
					});';
					$_SESSION["department_error_msg"] = null;
				}


				// success in adding
				if (isset($_SESSION["department_success_msg"])){
					echo '$(document).ready(function() {
						$("#success_modal_body_add").html("'.$_SESSION["department_success_msg"].'");
						$("#add_successModal").modal("show");
					});';
					$_SESSION["department_success_msg"] = null;
				}
	...
	<body>
		...
		<div class="sidebar">
			<ul class="nav">
				...
				<li class="parent">
					<a href="department_list.php" style="background-color:#1d8348;">
			...
			<div class="container-fluid">
				<div class="row" style="border-bottom:1px solid #BDBDBD;">
					<ol class="breadcrumb">
						...
						<li class="active" id="home_id">Department</li> 
					</ol>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-sm-12 content-div">
						<div class="thumbnail" style="border:1px solid #BDBDBD;">
							<div class="caption">
								<fieldset>
									<legend style="color:#357ca5;border-bottom:1px solid #BDBDBD"><span class="glyphicon glyphicon-list-alt"></span> Department List <small class="pull-right"><a href="#add_dept_modal" data-toggle="modal" class="custom-add-items"><span class="glyphicon glyphicon-plus"></span>Add New</a></small></legend>
									<span><small><b><span class="glyphicon glyphicon-info-sign" style="color:#2E86C1;"></span> Note: If the department already used for position it can not be edit and delete.</b></small></span><br/><br/>
			...
			<!-- Modal content-->
				<div class="modal-content">
					<div class="modal-header" style="background-color:#357ca5;">
						...
						<h5 class="modal-title" style="color:#fff"><span class='glyphicon glyphicon-pencil' style='color:#b7950b'></span> Edit Department</h5>
					</div> 
			...
			<!-- Modal content-->
				<div class="modal-content">
					<div class="modal-header" style="background-color:#b03a2e;">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h5 class="modal-title" style="color:#fff"><span class='glyphicon glyphicon-alert' style='color:#fff'></span>&nbsp;Edit Department Notification</h5>
					</div> 
			...
			<!-- Modal content-->
				<div class="modal-content">
					<div class="modal-header" style="background-color:#1d8348;">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h5 class="modal-title" style="color:#fff"><span class='glyphicon glyphicon-check' style='color:#fff'></span>&nbsp;Edit Department Notification</h5>
					</div> 
		...
		<div id="deleteDepartmentConfirmationModal" class="modal fade" role="dialog" tabindex="-1">
			<div class="modal-dialog modal-sm">
			<!-- Modal content-->
				<div class="modal-content">
					<div class="modal-header" style="background-color:#21618c;">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h5 class="modal-title" style="color:#fff"><span class='glyphicon glyphicon-trash' style='color:#fff'></span>&nbsp;Delete Department Notification</h5>
					</div> 
					...
					<div class="modal-footer" style="padding:5px;text-align:center;" id="delete_modal_footer">
						<a href="#" class="btn btn-default" id="delete_yes_dept">YES</a>
		...
		<!-- FOR ADD NEW MODAL -->
		<div id="add_dept_modal" class="modal fade" role="dialog" tabindex="-1">
			<div class="modal-dialog modal-sm">
			<!-- Modal content-->
				<div class="modal-content">
					<div class="modal-header" style="background-color:#1b4f72;">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h5 class="modal-title" style="color:#fff"><span class='glyphicon glyphicon-plus' style='color:#fff'></span>&nbsp;Add Department</h5>
					</div> 
					<div class="modal-body">
						<div class="container-fluid">
							<form class="form-horizontal" action="php script/add_department_script.php" method="post">		
								<div class="col-sm-12">
									<div class="form-group">
										<label class="control-label"><span class="glyphicon glyphicon-blackboard" style="color:#2E86C1;"></span> Department</label>
										<div class="input-group">
											<input type="text" name="department" autocomplete="off" placeholder="Enter Department" class="form-control" required="required">
