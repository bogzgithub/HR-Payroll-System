	...
	<body>
			...
			<ul class="nav">
				...
				<li class="parent">
					<a data-toggle="collapse" href="#sub-item-1-attendance">
						<span class="glyphicon glyphicon-time"></span>&nbsp; Attendance <span class="pull-right glyphicon glyphicon glyphicon-menu-up" id=""></span>
					</a>
					<ul class="children collapse in" id="sub-item-1-attendance">
						<li class="">
							<a class="active-sub-menu" href="attendance_upload.php">
		...
		<div class="content">
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-sm-12">
						<div class="panel panel-success content-element">
							 ...
							 <div class="panel-body">
								<form class="form-inline" method="post" action="../php script/upload_attendance_script.php" enctype="multipart/form-data">
									<fieldset>
										<div class="form-group col-sm-6 col-sm-offset-3 upload-div">
